...
#' Gets simulated data from Case_2 
#'
#' @param x The x used to generate the clusters
#' @param n The number of curves per cluster 
#' 
#' @return The simulated data from Case_2
#' 
#' @export
#'
#' @examples
...
#' Gets simulated data from Case_5
#'
#' @param x The x used to generate the clusters
#' @param n The number of curves per cluster 
#' 
#' @return The simulated data from Case_5 
#' 
#' @export
#'
#' @examples
