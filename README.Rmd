...
#### Arguments 
* **x**: A vector of values which the functional data is evaluated over
...
* **convergence_threshold**: The threshold that determines when the model has converged. (Optional)
...
* **plot_params**: List of parameters corresponding to characteristics of the plot

### Return Value 
The funclustVI function returns a list with the following entries:

* **probability_matrix**: A matrix in which the columns are the probabilities that the curve belongs to that cluster
...
#### Arguments 
* **data_params**: List object containing the parameters required for generating the functional data and its characterics
* **model_params**: List object containing the parameters required for modelling the data and generating the cluster assignments 
* **eval_func_list**: List object containing the functions corresponding to the various evaluations metrics evaluation the performance of the algorithim
* **number_of_simulationa**: The number of simulations 
